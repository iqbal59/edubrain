    ...
    public function save($module=''){
        switch (strtolower($module)) {
            case 'profile':{                
                ...
                $this->student_m->save($form,$this->LOGIN_USER->mid);
            ...
            case 'password':{                
                ...
                if($this->student_m->hash($form['password'])!=$this->LOGIN_USER->password){
                    $this->session->set_flashdata('error', 'Wrong Current password');
                    redirect($this->LIB_CONT_ROOT.'profile/edit/password', 'refresh');                    
                }
                $this->student_m->save(array('password'=>$this->student_m->hash($form['npassword'])),$this->LOGIN_USER->mid);
            ...
            case 'preset':{                
                ...
                $this->student_m->save(array('password'=>$this->student_m->hash($form['password']),'reset_password'=>0),$this->LOGIN_USER->mid);
                $this->session->set_flashdata('success', 'Password Updated Successfully.');
