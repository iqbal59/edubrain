...
*/	
    ...
    public function groupview($rid='',$page=0){
        ...
        if(isset($form['clear']) ){$this->chat_group_message_m->delete(NULL,array('chat_group_id'=>$rid));}
        //load group chat
        $this->data['module_url']=$this->CONT_ROOT.'groupview/'.$rid.'';  
    ...
    public function messages($cid='',$page=0){
        ...
        $params['offset']=intval($page)*$params['limit'];
        ///////////////////////////////////////////////////////////////
        $chat=$this->chat_m->get_by_primary($cid);
        $this->data['chat_id']=$chat->mid;

        $this->chat_m->save(array('std_update'=>0),$chat->mid);
        ///////////////////////////////////////////////////////////////
        $search=array('name');
        if(isset($form['search'])){foreach($search as $value){$like[$value]=$form['search'];} }
        isset($form['search']) ? $params['like']=$like : '';
        ...
        $this->data['groups']=$this->group_m->get_values_array('','name',array());
        $this->data['sections']=$this->section_m->get_values_array('','name',array());
        $this->data['staff']=$this->staff_m->get_by_primary($chat->staff_id);
        $this->data['student']=$this->student_m->get_by_primary($chat->student_id);
        /////////////////////////////////////////////////////////////////
        $this->load->view($this->LIB_VIEW_DIR.'master', $this->data);   
    }
    ...
    public function upload_picture(){
        ...
        $redir=$this->CONT_ROOT.'messages/'.$chat->mid;
        ...
        $data['staff_id']=$this->LOGIN_USER->mid;
    ...
    */
    ...
    public function filterGroupMessages(){
        ...
        foreach($this->RESPONSE['rows'] as $row){
            ...
            $this->RESPONSE['rows'][$i]['message']=escape_html($row['message']);
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            $i++;
        }
        ///////////////////////////////////////////////
    ...
    */
    ...
    public function addMessage(){
        ...
        $this->chat_m->save(array('name'=>$form['message'],'stf_update'=>1),$chat->mid);
        //send back the resposne  
        echo json_encode($this->RESPONSE);exit();
    }
