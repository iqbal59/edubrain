...
*/	
	...
	public function index($module=''){
        ...
        switch (strtolower($module)) {
            ...
            case 'classes':{
                //add class
                $this->data['main_content']='index_classes';  
                ...
                $this->data['rows']=$this->class_m->get_rows($filter,$params);
            }
            break;
            case 'classlinks':{
                //add class
                $this->data['main_content']='index_classlinks';  
                $this->data['menu']='classlinks';            
                $this->data['sub_menu']='classlinks';
                ///////////////////////////////////////////////////////////////
                if(isset($form['subject'])&&!empty($form['subject'])){$like['subject']=$form['subject'];}
                count($like)>0 ? $params['like']=$like : '';
                ///////////////////////////////////////////
                ...
                $params['select']='mid,class_id,section_id,group_id,subject,teacher_name,class_time,id_password,zoom_link';
                $params['orderby']='class_id ASC, class_time ASC, section_id ASC';
                $this->data['rows']=$this->class_link_m->get_rows($filter,$params);
            }
            break;
            case 'sections':{
                //add class
                $this->data['main_content']='index_sections';  
                ...
                ///////////////////////////////////////////
                $params['select']='mid,name';
                $this->data['rows']=$this->section_m->get_rows($filter,$params);
            }
            break; 
            case 'groups':{
                //add class
                $this->data['main_content']='index_groups';  
                ...
                ///////////////////////////////////////////
                $params['select']='mid,name';
                $this->data['rows']=$this->group_m->get_rows($filter,$params);
            }
            break;  
            case 'subjects':{
                //add class
            ...
            case 'lessons':{
                ...
                if(isset($form['class_id'])&&!empty($form['class_id'])){$filter['class_id']=$form['class_id'];}
                if(isset($form['group_id'])&&!empty($form['group_id'])){$filter['group_id']=$form['group_id'];}
                if(isset($form['subject_id'])&&!empty($form['subject_id'])){$filter['subject_id']=$form['subject_id'];}
                if(isset($form['class_id'])&&!empty($form['class_id'])){$cls_filter['class_id']=$form['class_id'];}
                ///////////////////////////////////////////////////////////////
                $this->data['class_subjects']=$this->subject_m->get_values_array('','name',$cls_filter);
            ...
            case 'staff':{
                //add class
                $this->data['main_content']='index_staff';  
                ...
                ///////////////////////////////////////////
                $params['select']='mid,name,staff_id,mobile,image,father_name,dob,city,state,address,blood_group,religion,status,date';
                $this->data['rows']=$this->staff_m->get_rows($filter,$params);
            }
            break;  
            case 'students':{
                //add class
            ...
            case 'qbank':{
                ...
                if(isset($form['name'])&&!empty($form['name'])){
                    $like['question']=$form['name'];
                    $like['detail']=$form['name'];
                    $like['hint']=$form['name'];
                    $like['topic']=$form['name'];
                }
                count($like)>0 ? $params['like']=$like : '';
                if(isset($form['subject_id'])&&!empty($form['subject_id'])){$filter['subject_id']=$form['subject_id']; }
            ...
            case 'quiz':{
                ...
                if(isset($form['name'])&&!empty($form['name'])){$like['name']=$form['name'];}
                count($like)>0 ? $params['like']=$like : '';
                if(isset($form['sid'])&&!empty($form['sid'])){
                    $filter['subject_id']=$form['sid']; 
                    $this->data['subject']=$this->subject_m->get_by_primary($form['sid']);
                }
                if(isset($form['class_id'])&&!empty($form['class_id'])){$filter['class_id']=$form['class_id'];}
                if(isset($form['subject_id'])&&!empty($form['subject_id'])){$filter['subject_id']=$form['subject_id'];}
            ...
            case 'paper':{
                ...
                ///////////////////////////////////////////
                $this->data['classes']=$this->class_m->get_values_array('','name',array());
                $params['select']='class_id,section_id,subject_id,name,marks,date,jd,start_time,show_result,result_date';
                $params['orderby']='jd DESC, start_time ASC';
            ...
            case 'test':{
                //add class
                $this->data['main_content']='index_test';  
                $this->data['menu']='test';            
                ...
                $this->data['subjects']=$this->subject_m->get_values_array('','name',array());
                $this->data['classes']=$this->class_m->get_values_array('','name',array());
                $params['select']='student_id,class_id,subject_id,name,marks,date,jd';
                $this->data['rows']=$this->test_m->get_rows($filter,$params);
            }
            break;   
        }
        /////////////////////////////////////////////////////////////
