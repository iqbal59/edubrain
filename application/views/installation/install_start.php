				...
				<div class="card-body">
		            ...
		            <div class="row">
						...
						<div class="card card-body border-top-warning">
							...
							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="text" class="form-control" name="dbuser" placeholder="Enter Database User">
								<div class="form-control-feedback"><i class="icon-user text-muted"></i></div>
							</div>

							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="password" class="form-control" name="dbpassword" placeholder="Enter Database Password">
