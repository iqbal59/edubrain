...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container-fluid">			
			<div class="row">
				<div class="col-lg-12">	
					<h2 class="st_title"><i class="uil uil-book-open"></i>Generate New Quiz - Class <?php print ucwords($class->name.' - '.$subject->name); ?></h2>
				...
				<div class="col-md-12">
					<div class="card_dash1">
						...
						<div class="card_dash_right1">
							<button class="create_btn_dash" onclick="window.location.href = '<?php print $this->LIB_CONT_ROOT.'index/mdl/subjects/'.'?tab=quiz' ?>';">Go Back</button>
						</div>
					</div>
				</div>					
			</div>
			<form action="<?php print $this->CONT_ROOT.'save/quiz';?>" method="post">
				<input type="hidden" name="subject_id" value="<?php print $form['sid']; ?>">
				<div class="row">
					<div class="col-md-12">	
						<div class="row">
