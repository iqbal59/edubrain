...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container-fluid">			
			<div class="row">
				<div class="col-lg-12">	
					<h2 class="st_title"><i class="uil uil-database"></i>Quizzes - (<?php print $subject->name.' - '.$classes[$subject->class_id]; ?> Class)</h2>
					...
					<button  class="float-right" class="create_btn_dash" onclick="window.location.href = '<?php print $this->LIB_CONT_ROOT.'generate/mdl/quiz/?sid='.$subject->mid;?>';">Add New Test</button>
