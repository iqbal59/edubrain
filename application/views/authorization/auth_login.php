			...
			<div class="row justify-content-lg-center justify-content-md-center justify-content-sm-center">
				...
				<div class="col-lg-6 col-md-8 col-sm-10">
					<div class="sign_form">
						...
						<p class="form_title color-white font-bold font-size-18px p-5">STUDENT PORTAL</p>
						<?php 
						...
						<form action="<?php print $this->APP_ROOT.'auth/signin';?>" method="post">
							<div class="ui search focus mt-15">
								<div class="ui left icon input swdh95">
									<input class="prompt srch_explore" type="text" name="user_id" value="" required="" maxlength="64" placeholder="Enter Student ID">															
									<i class="uil uil-user icon icon2"></i>
								</div>
							</div>
							<div class="ui search focus mt-15">
								<div class="ui left icon input swdh95">
									<input class="prompt srch_explore" type="password" name="password" value="" required="" maxlength="64" placeholder="Password">
									<i class="uil uil-key-skeleton-alt icon icon2"></i>
								</div>
							</div>
							<button class="login-btn" type="submit"><i class="uil uil-lock icon icon2 color-black"></i>SIGN IN</button>
						</form>
						<br><p class="ssgntrm145">I am a teacher. <a href="<?php print $this->CONT_ROOT.'login/staff' ?>">Click Here</a> for teacher login.</p>
					</div>
