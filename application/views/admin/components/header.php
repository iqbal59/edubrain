...
<head>
  ...
  <title><?php print ucwords($this->config->item('app_name'));?> |  Admin Area</title>
  ...
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>admin/app_module.js<?php print $this->FILE_VERSION;?>"></script>
  <?php  foreach($this->ANGULAR_INC as $inc){?>
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>admin/<?php print $inc;?>.js<?php print $this->FILE_VERSION;?><?php print mt_rand(100,999999);?>"></script>
  <?php }} ?>
  <!-- /angular js files -->
