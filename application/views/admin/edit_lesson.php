						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore datepicker-here" type="text" name="lesson_date" value="<?php print $row->lesson_date;?>" required=""  readonly="" min="1" max="255" placeholder="dd-mm-yyyy">															
									</div>
								</div>										
							</div>
