...
<div class="wrapper" ng-controller="mozzCtrl"  ng-cloak>
	<div class="sa4d25">
		<div class="container-fluid" ng-init="rid='<?php print $chat_id;?>'">			
								...
								<div class="chatbox_right">
									<div class="chat_header">
										<div class="user-status">
											<p class="user-status-title"> Messages to <span class="bold"><?php print $student->name ?></span></p>
										</div>
									</div>
									...
									<div class="message-send-area">
											<div class="mf-field">
												...
												<button class="add_msg"><i class="uil uil-message" ng-click="sendMessage()"></i></button>
											</div>
										<hr>
										<?php echo form_open_multipart($this->CONT_ROOT.'upload_picture');?> 
											<input type="hidden" name="rid" value="<?php print $chat_id;?>">
