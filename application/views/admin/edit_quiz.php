...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container-fluid">			
			<div class="row">
				<div class="col-lg-12">	
					<h2 class="st_title"><i class="uil uil-book-open"></i>Edit Quiz - Class <?php print ucwords($class->name); ?></h2>
			...
			<form action="<?php print $this->CONT_ROOT.'save/quiz/'.$row->mid;?>" method="post">
				<div class="row">
					<div class="col-md-12">	
						<div class="row">
							...
							<div class="col-lg-3 col-md-3">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore" type="text" name="name" value="<?php print $row->name; ?>" required="" min="1" max="99" placeholder="Enter Quiz Name">															
									</div>
								</div>										
							</div>
							<div class="col-lg-2 col-md-2">	
								<div class="ui search focus mt-20 lbel25">
									<label>Chpater (optional)</label>
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore" type="text" name="chapter" value="<?php print $row->chapter; ?>" placeholder="Chapter Number">															
									</div>
								</div>										
							</div>
							<div class="col-lg-3 col-md-3">	
							...
							<div class="col-lg-12 col-md-12">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<textarea class="prompts srch_explore" name="instructions" placeholder="Write quiz instuctions" rows="10" cols="800"><?php print $row->instructions; ?></textarea>
									</div>
								</div>										
							</div>
						</div>
						<div class="row">
							<div class="col-lg-3 col-md-3">	
								<br>
								<button class="create_btn_dash" type="submit">Update Quiz</button>										
							</div>
						</div>	
					</div>
				</div>
