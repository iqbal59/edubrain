								...
								foreach($rows as $row){
								 ...
								 ?>
	                                <tr>
										...
										<td class="text-center"><b><a href="<?php print $this->LIB_CONT_ROOT.'chat/messages/'.$row['mid'];?>"><?php print real_html($row['name']); ?></a></b> 
										...
										<td class="text-center">
											<a href="<?php print $this->LIB_CONT_ROOT.'delete/mdl/messages/?rid='.$row['mid'];?>" onclick="return confirm('Are you sure to delete?')" title="Delete" class="gray-s"><i class="uil uil-trash-alt"></i></a>
										</td>
									</tr>
								 <?php } ?>
                            </tbody>
