								...
								<div class="chatbox_right">
										...
										<div class="user-status">
											...
											<div class="user-status-time floaty eps_dots eps_dots5 more_dropdown">
												...
												<div class="dropdown-content">
													<a href="<?php print $module_url.'?clear' ?>"><span><i class="uil uil-trash-alt"></i>Clear Chat</span></a>
									...
									<div class="message-send-area">
										...
										<?php echo form_open_multipart($this->CONT_ROOT.'group_upload_picture');?> 
											...
											<button class="add_msgs" type="submit" class="btn btn-info"><i class="uil uil-message"></i>Upload</button>										
										<?php echo form_close(); ?>
									</div>
								</div>
							</div>
