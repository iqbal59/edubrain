...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container-fluid">			
			...
			<form action="<?php print $this->CONT_ROOT.'save/students/'.$row->mid;?>" method="post">
				<div class="row">
					<div class="col-md-12">	
						<div class="row">
							...
							<div class="col-lg-4 col-md-4">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore" type="text" name="roll_number" value="<?php print $row->roll_number;?>" placeholder="Enter Roll Number">															
									</div>
								</div>										
							</div>
							<div class="col-lg-4 col-md-4">	
							...
							<div class="col-lg-4 col-md-4">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore" type="text" name="student_id" value="<?php print $row->student_id;?>" placeholder="Enter Student ID">															
									</div>
								</div>										
							</div>
							...
							<div class="col-lg-3 col-md-3">
								...
								<select class="ui hj145 dropdown cntry152 prompt srch_explore" name="status">
									...
									<option value="active" <?php print 'active'==$row->status ? 'selected': ''; ?> >Active</option>
									<option value="inactive" <?php print 'inactive'==$row->status ? 'selected': ''; ?> >Disable</option>
								</select>
							</div>
