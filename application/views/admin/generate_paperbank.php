...
<div class="wrapper _bg4586" ng-controller="mozzCtrl"  ng-cloak>
	...
	<div class="_216b01" ng-init="rid='<?php print $paper->mid; ?>'">
		<div class="container">			
					...
					<div class="section3125 rpt145">							
						<div class="row">						
							<div class="col-lg-7">	
								...
								<div class="dp_dt150">	
									<div class="prfledt1">
										<h2>Paper: <?php print ucwords($paper->name);?></h2>
										<span><strong>Class:</strong> <?php print ucwords($class->name); ?> </span> | 
										<span><strong>Subject:</strong> <?php print ucwords($subject->name); ?></span> | 
										<span><strong>Date:</strong> <?php print ucwords($paper->date); ?></span> | 
										<span><strong>Start Time:</strong> <?php print get_time_from_minutes($paper->start_time,false); ?></span>
									</div>										
								</div>
								<ul class="_ttl120">
									<li>
										<div class="_ttl121">
											...
											<div class="_ttl123">{{record.total_questions_detail}}</div>
										</div>
									</li>
									<li>
										<div class="_ttl121">
									...
									<li>
										<div class="_ttl121">
											...
											<div class="_ttl123"><?php print $paper->difficulty; ?>%</div>
										</div>
									</li>
								</ul>
								<p class="mt-2">									
									<a href="<?php print $this->LIB_CONT_ROOT.'delete/mdl/paperbank/?rid='.$paper->mid;?>" class="text-danger">
									...
									<div class="_14d25">
											...
											<div class="row text-right">
												<div class="col-md-12">
													<select class="" name="type">
														...
														<option value="mcq" <?php if(isset($form['type']) && $form['type']=='mcq'){print 'selected';}?>>MCQ Only</option>
														<option value="short" <?php if(isset($form['type']) && $form['type']=='short'){print 'selected';}?>>Short Only</option>
														<option value="long" <?php if(isset($form['type']) && $form['type']=='long'){print 'selected';}?>>Long Only</option>
													</select>
										...
										<div class="row">
											<div class="table-responsive mt-30">
														...
														foreach($rows as $row){
														 ...
														 ?>
							                                <tr>
																...
																<td class="text-center"><?php print real_html($row['answer']); ?></td>
																<td class="text-center"><?php print real_html($row['marks']); ?></td>
																<td class="text-center"><?php print isset($row['chapter'])?$row['chapter']:''; ?></td>
																<td class="text-center"><?php print isset($row['type']) ? $row['type']:''; ?></td>
																<td class="text-center">
												...
												<p class="mt-2">									
													<a href="<?php print $this->LIB_CONT_ROOT.'generate/mdl/paperbank/'.$paper->mid.'?tab=qbadd&action=multisave&qid='.$q_ids;?><?php if(!empty($mod_url_params)){print $mod_url_params;}?>" class="text-success">Add above all question into paper
													</a> 
												</p>
											</div>
										</div>		
