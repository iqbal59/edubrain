										...
										<div class="ques_item border-green-1">
											...
											<div class="ui search focus mt-15">																
												...
												<div class="row">
													<div class="col-lg-12">
														<?php 
														$docs=$this->paper_doc_m->get_rows(array('question_id'=>$row['mid'],'paper_id'=>$paper->mid,'student_id'=>$student->mid),array('select'=>'mid,file_name,date')); 
														if(count($docs)>0){ ?>
															<p>
																File uploaded by student regarding this question<br>
