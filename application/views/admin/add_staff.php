...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container-fluid">			
			...
			<form action="<?php print $this->CONT_ROOT.'save/staff';?>" method="post">
				<div class="row">
					<div class="col-md-12">	
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">	
								<div class="ui search focus mt-20 lbel25">
									...
									<div class="ui left icon input swdh19">
										<input class="prompt srch_explore" type="password" name="password" value="" placeholder="Enter Account password for the staff Name">															
									</div>
								</div>										
							</div>
