			...
			<div class="row">
				<div class="col-lg-12">	
					...
					This section heavily depends on time calculation so please update your timezone in <a href="<?php print $this->LIB_CONT_ROOT.'maintenance';?>">Settings</a> before creating and attempting paper.
					 ...
					 <!-- /alert -->
					<h2 class="st_title"><i class="uil uil-database"></i>Quiz Tests<?php if(isset($subject)){ ?> - (<?php print $subject->name; ?>) <?php } ?></h2>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body adcrse_body">
									<form action="<?php print $this->LIB_CONT_ROOT.'generate/mdl/quiz/';?>" method="get">
										<div class="row">
											<div class="col-lg-12">
												<div class="discount_form">
													<div class="row">
														...
														<div class="col-lg-6 col-md-6">	
															<button class="discount_btn mt-50" type="submit">Add New Quiz Test</button>
														</div>
													</div>
												</div>
											</div>
							 ...
							 ?>
                                <tr>
									...
									<td>
										...
										<a href="<?php print $this->LIB_CONT_ROOT.'analytics/report/quiz/'.$row['mid'];?>" title="View Report">View Report</a>
										<?php }else{
									...
									<td>
										<a href="<?php print $this->LIB_CONT_ROOT.'printer/mdl/quiz/'.$row['mid'];?>" title="Print Paper" class="gray-s" target="_blank"><i class="uil uil-print"></i></a>
										<a href="<?php print $this->LIB_CONT_ROOT.'edit/mdl/quiz/'.$row['mid'];?>" title="Edit" class="gray-s"><i class="uil uil-edit-alt"></i></a>
										<a href="<?php print $this->LIB_CONT_ROOT.'generate/mdl/quizbank/'.$row['mid'];?>" title="Question Bank" class="gray-s"><i class="uil uil-database"></i></a>
										<a href="<?php print $this->LIB_CONT_ROOT.'delete/mdl/quiz/?rid='.$row['mid'];?>" onclick="return confirm('Are you sure to delete?')" title="Delete" class="gray-s text-danger"><i class="uil uil-trash-alt"></i></a>
									</td>
								</tr>
							 <?php } ?>
                        </tbody>
