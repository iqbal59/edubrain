							...
							foreach($subjects as $row){
								...
								$i++; ?>
									...
									<td class="text-center">
										<a href="<?php print $this->CONT_ROOT.'homework/'.$row['mid'];?>" title="View Homework" class="text-danger"><b>View Homework</b></a> | 
										<a href="<?php print $this->LIB_CONT_ROOT.'notes/view/'.$row['mid'];?>" title="View Notes " class="text-info"><b>View Notes</b></a>
									</td>
									</tr>
