...
<!-- Body Start -->
						...
						<div class="cmtk_dt">
							...
							<?php if(!empty($paper->instructions)){ ?>
								...
								<span class="color-white text-left">
									...
									<div class="color-white text-left"><?php print $paper->instructions; ?></div>
								</span>
							<?php } ?>
						</div>
	...
	<?php 
		...
		$js_date="$year"."-".sprintf('%02s',$month)."-".sprintf('%02s',$day)."T".get_time_from_minutes($paper->start_time).":00.000".date('P');
	 ?>
