...
?>
		...
		<div class="container exam_container">
			<div class="row soft_padding">
				<div class="col-lg-10 col-md-10">
					<a href="<?php print $paper_url.'/?finish';?>" onclick="return confirm('Are you sure to end paper? You can not resume paper afterwards.');" class="btn btn-danger">End Paper</a>
			...
			<div class="container exam_container">
				<div class="row soft_padding">				
						...
						<div class="right_side">
							<div class="fcrse_2 mb-30">
								<div class="tutor_content_dt">
									<div class="tutor150">
										<a class="tutor_name">Paper Information</a>
									</div>
									<hr>
									<div class="tutor_cate">
										<strong>Quiz Name : </strong><?php print ucwords($paper->name);?> <br>
									...
									<a href="<?php print $paper_url.'/?prev';?>" class="btn btn-info"><i class="uil uil-angle-double-left"></i>Previous</a> 
									<?php endif ?>
									 | 
									<?php if ($current_question+1<count($questions)): ?>
									<a href="<?php print $paper_url.'/?next';?>" class="btn btn-info">Next <i class="uil uil-angle-double-right"></i></a>
					...
					<div class="col-lg-9 col-md-9 right_bar">
						...
						<form action="<?php print $this->CONT_ROOT.'attempt/'.$paper->mid;?>" method="post">
							...
							<div class="certi_form">
								<div class="all_ques_lest">
									<div class="ques_item">
										...
										<?php switch(strtolower($question->type)){
											//mcq question
											case 'mcq':{
												?>
												<div class="ui form">
											...
											case 'short':{
												...
												<div class="ui search focus mt-15">																
													<div class="ui form swdh30">
														<div class="field">
															<textarea class="editor2" rows="5" name="answer" placeholder="Write your answer here..."><?php if(isset($answers[$question->mid]) && !empty($answers[$question->mid])){print $answers[$question->mid];} ?></textarea>
														</div>
													</div>
												</div>
											...
											case 'long':{
												...
												<div class="ui search focus mt-15">																
													<div class="ui form swdh30">
														<div class="field">
															<textarea class="editor3" rows="5" name="answer" placeholder="Write your answer here..."><?php if(isset($answers[$question->mid]) && !empty($answers[$question->mid])){print $answers[$question->mid];} ?></textarea>
														</div>
													</div>
												</div>
						...
						<?php if(strtolower($question->type)=='short' || strtolower($question->type)=='long'){ ?>
						<div class="ui focus mt-10 mb-10">																
							<div class="ui">
								<p>Upload a document or image here...<br>
								<?php echo form_open_multipart($this->CONT_ROOT.'upload_paper_doc/'.$paper->mid);?> 
									<input type="hidden" name="question_id" value="<?php print $question->mid;?>">
									<input type="hidden" name="subject_id" value="<?php print $subject->mid;?>">
									<input type="file" name="file">
									<button type="submit"><i class="uil uil-arrow-up"></i>Upload File</button>										
								<?php echo form_close(); ?>
								</p>
					...
					<div class="col-lg-12 col-md-12">
						<p>
							...
							foreach ($indexes as $id => $value) {
								?>
								<li class="<?php if(array_key_exists($value, $answers)){print 'active ';}?>"><a href="<?php print $paper_url.'/?qi='.$id;?>"><?php print $q+1 ?></a></li>
								<?php $q++; } ?>
								<?php if ($current_question+1==count($questions)): ?>
								<li class="min-w150 bg-orange"><a href="<?php print $paper_url.'/?finish';?>">End Paper</a>
								</li>
								<?php endif ?>
							</ul>
						</p>
	...
	<!-- Body End -->
	<?php 
		$day=get_day_from_date($paper->date);
		$month=get_month_from_date($paper->date);
		$year=get_year_from_date($paper->date);
 ...
 ?>
	<script type="text/javascript">
		$('#goto').change(function() {
		    window.location = "<?php print $paper_url;?>/?qi=" + $(this).val();
		});
	</script>