...
<head>
  ...
  <title><?php print ucwords($this->config->item('app_name'));?> |  Student Dashboard</title>
  ...
  <?php } ?>
  <link href="<?php print $this->RES_ROOT;?>css/look.css<?php print $this->FILE_VERSION;?>" rel="stylesheet">
  ...
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>dashboard/app_module.js<?php print $this->FILE_VERSION;?>"></script>
  <?php  foreach($this->ANGULAR_INC as $inc){?>
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>dashboard/<?php print $inc;?>.js<?php print $this->FILE_VERSION;?><?php print mt_rand(100,999999);?>"></script>
  <?php }} ?>
  <!-- /angular js files -->
  <style type="text/css">
    .card_dash{
      background-color: rgba(<?php print mt_rand(1,255);?>, <?php print mt_rand(1,255);?>, <?php print mt_rand(1,255);?>, .2);
    }
  </style>

</head>
<body ng-app="mozzApp" <?php print $body_init;?>>