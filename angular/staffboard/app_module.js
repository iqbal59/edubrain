...
//////////////////////////////////////////////////////////////////////////////
app.value('config',{
	ajaxModule:'../staffboard/',
	globalInterval:30000,	//30 seconds
	globalTimeout:10000,	//10 seconds
	messageSize:760,		//760 for english sms
	unicodeMessageSize:330,	//330 for urdu sms
	pageLimit:100,
	currentPage:0,
	responseNumRows:0,
	showLog:true,
...
app.filter('roundMsg', function (){ 
    return function (input, is_ascii){
        var len=1;var ascii_size=160;var ascii_divider=153;var unicode_size=70;var unicode_divider=67;
		if(is_ascii){
			if(input>ascii_size){len=Math.ceil(input/ascii_divider);}			
		}else{			
			if(input>unicode_size){len=Math.ceil(input/unicode_divider);}
		}
        return len;
    };
});
...
app.run(function($rootScope,config){
	...
	//////////////////////////////////////////////////////////////
	$rootScope.isAscii=function(message){
		if(typeof(message)!=='string'){return false;}
		for(var i=0;i<message.length;i++){
			if(message.charCodeAt(i)>127){return false;}
		}
		return true;
	}
	//////////////////////////////////////////////////////////////
